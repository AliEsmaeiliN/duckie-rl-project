...
parser.add_argument("--dynamics-rand", action="store_true", help="enable dynamics randomization")
...
def on_key_press(symbol, modifiers):
    ...
    if symbol == key.BACKSPACE or symbol == key.SLASH:
        ...
        env.unwrapped.set_randomization(domain_rand=True, camera_rand=True)
